...
from .catalogos_models import Sitio, EstadoCobro, Embarcacion, UnidadMedida, Tipo
...
class Produccion(models.Model):
    ...
    id_tipo_partida = models.ForeignKey(Tipo, on_delete=models.CASCADE, limit_choices_to={'tipo': 'PARTIDA'}, 
    ...
    id_estado_cobro = models.ForeignKey(EstadoCobro, on_delete=models.CASCADE)
    id_tipo_produccion = models.ForeignKey(Tipo, on_delete=models.CASCADE, limit_choices_to={'tipo': 'PRODUCCION'},
