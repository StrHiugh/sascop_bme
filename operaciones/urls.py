...
urlpatterns = [
    ...
    path("centro_consulta/descargar-excel-info/", centro_consulta.fn_api_descargar_excel_prod_info, name="api_descargar_excel_prod_info"),
    path("centro_consulta/enviar-correo/", centro_consulta.fn_api_enviar_correo_bi, name="api_enviar_correo_bi"),
    path("centro_consulta/enviar-correo-info/", centro_consulta.fn_api_enviar_correo_info, name="api_enviar_correo_info"),
